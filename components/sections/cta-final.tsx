...
export function CtaFinal() {
  return (
    <section className="cta-final-glow border-t border-line py-24">
      <Container className="flex flex-col items-center gap-6 text-center">
        <Reveal>
          <h2 className="max-w-2xl font-display text-3xl font-bold text-text sm:text-4xl">{ctaFinal.titulo}</h2>
        </Reveal>
        <Reveal delay={0.1}>
          <p className="cta-final-glow-quote font-display text-sm italic">&ldquo;{ctaFinal.citacao}&rdquo;</p>
        </Reveal>
        <Reveal delay={0.2}>
