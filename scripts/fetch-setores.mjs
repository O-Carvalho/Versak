...
// slug -> [id principal, id fallback] (todos verificados HTTP 200 e conferidos visualmente em 2026-07-11)
const SETORES = [
  // A escolha original ("photo-1565043666747-69f6646db940") era um close de farol de
  // carro num pátio — não representa manufatura. Trocado por uma cena real de linha de
  // montagem industrial (carroceria + braço robótico).
